...
const DEFAULT_CTF_EXCHANGE_ADDRESS = (process.env.NEXT_PUBLIC_CTF_EXCHANGE_ADDRESS
  ?? '0x006ce6484eA6114fB0D4F26660de0F37d35001Ba') as `0x${string}`

const DEFAULT_NEG_RISK_CTF_EXCHANGE_ADDRESS = (process.env.NEXT_PUBLIC_NEGRISK_CTF_EXCHANGE_ADDRESS
  ?? '0x68dDb555b640De7f0D7eFFd31ee5CCB841DD86AD') as `0x${string}`
