...
// Mock data - apenas um exemplo como solicitado
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mb-1 flex items-start justify-between gap-2">
                      ...
                      {/* Tempo + ícone externo (direita superior) */}
                    ...
                    {/* Linha inferior - informações extras */}
                    <div className="mt-1">
