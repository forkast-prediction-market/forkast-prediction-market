...
- **Default rate:** 1.00% per trade (100 basis points) pulled from the affiliate settings.
...
<Callout type="info" title="How the math works">
  Trading fee (USDC) = Order notional × 1.00%.
  A 150 USDC fill at the default rate costs 1.50 USDC in fees.
</Callout>
...
- **Affiliate share:** 40% of the trading fee (current configuration)
- **Platform share:** 60% of the trading fee
